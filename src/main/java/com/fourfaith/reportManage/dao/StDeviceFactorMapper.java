...
public interface StDeviceFactorMapper {
    ...
    int deleteStcd(String var1);

    List<StDeviceFactor> getDfList(Map<String, Object> var1);

    List<StDeviceFactor> findMaxPj(Map<String, Object> var1);
}
