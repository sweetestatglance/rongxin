...
public class AlexHQLineController {
    ...
    public ModelAndView index(HttpServletRequest request, boolean isDevice) throws UnsupportedEncodingException {
        ModelAndView modelAndView = getdatas(request, isDevice);
        return modelAndView;
    }

    public ModelAndView getdatas(HttpServletRequest request,boolean isDevice) throws UnsupportedEncodingException {
        ModelAndView mav = new ModelAndView("/page/hqline/index");
