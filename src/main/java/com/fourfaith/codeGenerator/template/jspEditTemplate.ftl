...
<div id="edit${entityPackage}Window" style="display: none;">
	<form id="${entityPackage}Form">
	     <input type="hidden" name="id" value="${entityPackage}.id">
	      <div class="popup">
	        <div class="window">
	          <div class="popup_top">
			   ...
			   <#list columns as po>
				    <li>
					     ...
					     <div class="popup_edit">
					            <input name="${po.fieldName}" id="${po.fieldName}" type="text" class="ck" value="${entityPackage}.${po.fieldName}"/>
					     </div>
				     </li>
			     </#list>
			  </ul>
