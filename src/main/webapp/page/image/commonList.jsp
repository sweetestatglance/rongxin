							...
							<div style="position:absolute;">
								<div class="container">
									<div class="example col-xs-3 col-xs-3">
									  <div style="border:1px solid #aab1b5;width:203px">
										<c:choose>
											<c:when test="${item.iscamera==1}">
												<c:choose>
													<c:when test="${item.imgurl==null}">
														<img src="${ctx}/content/skin/css/images/gap200.png" title="<fmt:message key="noPicture"/>"  width="200" height="200" style="padding:2px"></img>
													</c:when>
													<c:otherwise>
														<img src="${item.imgurl}" onerror="javascript:this.src='${ctx}/content/skin/css/images/fail200.png';javascript:this.title='<fmt:message key="picLoadFailed"/>'"  width="200" height="200" style="padding:2px" />

													</c:otherwise>
												</c:choose>
											</c:when>
											<c:otherwise>
												<img src="${ctx}/content/skin/css/images/no-camera200.png" title="<fmt:message key="missedCamera"/>" width="200" height="200" style="padding:2px"></img>
											</c:otherwise>
										</c:choose>
									</div>
                                   </div>
