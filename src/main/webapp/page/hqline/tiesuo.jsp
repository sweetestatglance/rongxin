	...
	<thead>
		<tr>
			...
			<c:forEach var="item"  items="${viewHead}" varStatus="vs">
			 ...
			 <%--<th width="80px"><fmt:message key="waterLevel"/></th>
			<th width="80px%"><fmt:message key="rainfall"/></th>
			<th width="80px%"><fmt:message key="flow"/></th>
			<th width="80px%"><fmt:message key="voltage"/></th>
			<th width="80px"><fmt:message key="ph"/></th>
			<th width="80px"><fmt:message key="turbidity"/></th>
			<th width="80px"><fmt:message key="dissolvedOxygen"/></th>
			<th width="80px"><fmt:message key="conductivity"/></th>
			<th width="80px"><fmt:message key="temperature"/></th>--%>
