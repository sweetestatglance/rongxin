			...
			<div class="operateNew" style="padding-left: 10px;">
			    ...
			    <div id="allArea" style="float:left;font-size:14px; margin-right: 10px;">
			    	...
			    	<div class="selDiv" id="timeSearchArea" style="float: left;">
						...
						<span>&nbsp;&nbsp;<fmt:message  key="endTime"/>：</span> <input id="query_endTime" class="Wdate"
					...
					<div class="selDiv" id="yearSearchArea" style="display:none;float:left;">
						...
						<input class="Wdate query_Time" value="<fmt:formatDate value="${defaultTime}" pattern="yyyy" />" id="yearSearchAreaDate" type="text"
							onfocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy',maxDate:'{%y}'})" />
					</div>
				</div>
			
				<input type="button" class="btn-search" value="<fmt:message key="query"/>" onclick="searchAlmanacReportList()">
				
				<input type="button" class="btn-export" value="<fmt:message key="export"/>" onclick="exportReportForm1(this)">
