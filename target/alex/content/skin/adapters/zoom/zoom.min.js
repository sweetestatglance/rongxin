(function(e) {
	function u(u) {
		function c() {
			...
			var t = e(this), r = parseInt(n.css("borderLeftWidth")), i = s - r
					* 2, u = o - r * 2, a = t.width(), f = t.height();
	...
	function a() {
		var t = i.parent("div").prev();
		if (t.length != 0)
//			t = e(".gallery li:last-child");
			t.find("a").trigger("click")
	}
	function f() {
		var t = i.parent("div").next();
		if (t.length != 0)
//			t = e(".gallery li:first-child");
	...
	var t = e("#zoom").hide(), n = e("#zoom .content"), r = false, i = null, s = e(
			window).width(), o = e(window).height();
	(function() {
		...
		if (e(".gallery div a").length == 1)
			e(".gallery div a")[0].addClass("zoom");
		e(".zoom, .gallery div a").on("click", u)
	})();
	(function() {
